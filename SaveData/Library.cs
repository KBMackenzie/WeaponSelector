...
namespace WeaponSelector
{
    internal class Library
    {
        ...
        Dictionary<CurseChoices, string> curseNames = new Dictionary<CurseChoices, string>()
        {
            ...
            { CurseChoices.SailorsGrave,        "Sailor's Grave"            },
            { CurseChoices.PassageoftheMariner, "Passage of the Mariner"    },
            ...
            { CurseChoices.IchorConsuming,      "Ichor Consuming"           },
            ...
            { CurseChoices.TrailBlazed,         "Trail Blazed"              },
            ...
            { CurseChoices.DeathsDisregard,     "Death's Disregard"         },
        ...
        Dictionary<CurseChoices, EquipmentType> curses = new Dictionary<CurseChoices, EquipmentType>()
        {
            ...
            { CurseChoices.SailorsGrave,        EquipmentType.Tentacles_Backwards   },
            { CurseChoices.PassageoftheMariner, EquipmentType.Tentacles_Long        },
            ...
            { CurseChoices.IchorConsuming,      EquipmentType.ProjectileAOE_BiggerRadius},
            ...
            { CurseChoices.TrailBlazed,         EquipmentType.Fireball_Backwards    },
            ...
            { CurseChoices.DeathsDisregard,     EquipmentType.MegaSlash_DeflectsBullets},
